...
<div class="hero">
  <div class="hero-text">
    ...
    where authority sits inside developing countries, and how places connect to
...
On power, my thesis, *Power and Place*, asks where authority sits in African
urban government and what follows from that placement. I measure it through a
framework of capacity, authority and means, drawing on two decades of
Afrobarometer surveys, a model-assisted coding of metropolitan legislation
since the early 1990s, and IMF fiscal data, and then trace what it does to
local public goods and to Uganda's new cities. On connection, I ask how foreign
